...
def check_generated_box():
    ftrain = ["processed_data/train/train.box.val.id",
              "processed_data/train/train.box.lab.id",
              "processed_data/train/train.box.pos",
              "processed_data/train/train.box.rpos"]
    ftest = ["processed_data/test/test.box.val.id",
             "processed_data/test/test.box.lab.id",
             "processed_data/test/test.box.pos",
             "processed_data/test/test.box.rpos"]
    fvalid = ["processed_data/valid/valid.box.val.id",
...
class Vocab(object):
    ...
    def __init__(self):
        ...
        vocab['UNK_TOKEN'] = 3
        cnt = 4
        with open("C:/Users/11202/Desktop/AI/original_data/word_vocab.txt", "r", encoding="utf-8") as v:
            for line in v:
        ...
        key_map['UNK_TOKEN'] = 3
        cnt = 4
        with open("C:/Users/11202/Desktop/AI/original_data/field_vocab.txt", "r", encoding="utf-8") as v:
            for line in v:
